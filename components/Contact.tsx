...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 px-6 max-w-6xl mx-auto">
      {/* HEADING - Selalu di tengah dengan spacing yang cukup */}
          ...
          <div className="p-6 bg-dark-800/30 border border-white/10 rounded-xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">abidghufron11@gmail.com</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">Ponorogo, Indonesia</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 md:gap-4">
            {[
              ...
              >
                ...
                <span className="text-xs font-bold text-gray-300 group-hover:text-accent text-center">{social.label}</span>
              </motion.a>
            ))}
          </div>
        ...
        >
          {["name", "email"].map((field) => (
            <div key={field} className="relative">
              <input
                ...
                } rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-accent/50 transition-all placeholder:text-gray-500 text-white disabled:opacity-50`}
              />
              <motion.div 
          ...
          <div className="relative">
            <textarea
              ...
              disabled={loading}
              className={`w-full bg-dark-800/50 border ${
                focused === "message" ? "border-accent" : "border-white/10"
              } rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-accent/50 transition-all placeholder:text-gray-500 text-white resize-none disabled:opacity-50`}
            />
            <motion.div 
              className="absolute bottom-0 left-0 h-0.5 bg-accent" 
              initial={{ width: 0 }} 
          ...
          <motion.button
            ...
            disabled={loading}
            className="relative overflow-hidden w-full px-6 py-3.5 bg-accent text-black font-semibold rounded-lg flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <motion.div
            ...
            <span className="relative z-10">
              {loading ? (
                <><Loader2 className="animate-spin inline mr-2" size={16} /> Sending...</>
              ) : (
                "Send Message"
              )}
            </span>

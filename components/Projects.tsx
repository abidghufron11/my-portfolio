...
// Ganti dengan icon yang guaranteed exist
...
export default function Projects() {
  return (
    <section id="projects" className="py-24 px-6 max-w-6xl mx-auto">
      <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} className="text-center mb-16">
      ...
      <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects.map((p, i) => (
          <motion.div
            key={i}
            variants={fadeInUp}
            whileHover={{ y: -10, borderColor: "#FF6B35" }}
            className="group relative p-6 bg-dark-800/30 border border-white/10 rounded-xl overflow-hidden"
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex gap-4">
                ...
                <motion.a whileHover={{ scale: 1.05 }} href="#" className="flex items-center gap-2 text-sm text-gray-400 hover:text-white">
                  <GitBranch size={16} /> Code {/* GitBranch sebagai pengganti Github */}
                </motion.a>
              </div>
            </div>
